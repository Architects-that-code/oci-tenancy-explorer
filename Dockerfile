...
COPY --chown=appuser:appuser index.html build_fleet_data.py portal_server.py favicon.svg oci_config.example README.md SECURITY.md fleet_data.sample.json ./
